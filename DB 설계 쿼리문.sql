...
CARTITEMCOUNT NUMBER(10),
CARTTOTPRICE NUMBER(10),
CONSTRAINT ORDER_DETAIL_NUM FOREIGN KEY(ORDERNUM) REFERENCES CUSTOMERORDER(ORDERNUM),
CONSTRAINT ORDER_DETAIL_ID FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMER(CUSTOMERID)
);
