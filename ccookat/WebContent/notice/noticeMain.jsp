...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="<%=cp %>/Data/style/img/breadcrumb.jpg" style="background-image: url(&quot;<%=cp %>/Data/style/img/breadcrumb.jpg&quot;);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div align="right">
                            <input type="button" value="글 올리기" onclick="">
                            </div>
                        </div>
                    </div>
                </div>
