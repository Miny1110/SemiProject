				...
				<div id="qna_list">
					...
					<table class="qna_table">
						<tbody>
							...
							<!-- 	<th class="qna_tr" width="200">답변여부</th> -->
							</tr>
							<c:forEach var="qdto" items="${lists }">
								<tr id="lists">
									...
									<c:choose>
										<c:when
											test="${sessionScope.customerInfo.customerId==qdto.customerId||
									...
									<td class="qna_tr">${qdto.qnaHitCount }</td>
					 				<%-- <c:if test="${redto.qnaNum!=null and redto.replyContent==null }">
									<td class="qna_tr">답변완료</td>
									</c:if>
 --%>
					...
					<div class="qna_table_box">
						<div>
							<form action="" method="post" name="searchForm">
								<input class="qna_input" type="text" name="searchValue">
								<input class="qna_submit" type="button" value="검색"
									onclick="sendIt();" />
