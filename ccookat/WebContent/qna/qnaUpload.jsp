					...
					<div>
						<div>
							...
							<div>
								...
								<input class="blog__sidebar__item__tags_review" type="button" value=" 등록하기" onclick="sendIt();"> 
								<input class="blog__sidebar__item__tags_review" type="reset" value="다시입력" onclick="document.myForm.subject.focus();" />
								<input class="blog__sidebar__item__tags_review" type="button" value="작성취소" onclick="location='<%=cp%>/main/qna/list.do';" />
							</div>
