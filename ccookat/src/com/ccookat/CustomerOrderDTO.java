...
public class CustomerOrderDTO {
	...
	public void setCustomerOrderNum(int customerOrderNum) {
	...
	public String getCustomerOrderAddr() {
		return customerOrderAddr;
	}
	public void setCustomerOrderAddr(String customerOrderAddr) {
		this.customerOrderAddr = customerOrderAddr;
	}
